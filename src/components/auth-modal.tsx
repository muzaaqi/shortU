...
export const AuthModal = memo(function AuthModal({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogPopup>
        <DialogHeader>
          <DialogTitle>Sign In to shortU</DialogTitle>
          <DialogDescription>
            Connect your account to save your shortened links, manage custom aliases, and access click telemetry.
          </DialogDescription>
        </DialogHeader>
